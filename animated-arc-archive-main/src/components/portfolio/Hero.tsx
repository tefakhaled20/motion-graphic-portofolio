    ...
    <section id="top" className="relative flex min-h-screen w-full items-center overflow-hidden px-6 pb-24 pt-40 md:px-12">
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-12 lg:grid-cols-12">
        <div className="lg:col-span-8">
          ...
          >
            I'm <span className="text-foreground">Kai Mercer</span> — a motion designer and editor crafting cinematic stories for brands, artists and studios across the globe.
          </motion.p>
